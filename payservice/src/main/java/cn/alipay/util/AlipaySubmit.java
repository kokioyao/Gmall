...
import cn.alipay.config.AlipayConfig;
import cn.alipay.sign.RSA;
...
public class AlipaySubmit {
    ...
    public static void main(String arg[]){
    	String mysign = RSA.sign("a=123", AlipayConfig.private_key, AlipayConfig.input_charset);
	...
	public static List<String> validOutParams(Map<String, String> map){
		List<String> errlist=new ArrayList<String>();
		String[] must_params_in=  AlipayConfig.must_params_out;
